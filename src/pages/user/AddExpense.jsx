      ...
      <form onSubmit={handleSubmit}>
        <div className="flex flex-col lg:flex-row gap-6">
          <div className="flex-1 space-y-4">
            ...
            <div>
              <label htmlFor="merchant" className="block text-white text-sm mb-1">Merchant*</label>
              <input
                type="text"
                id="merchant"
                name="merchant"
            ...
            <div className="flex gap-2">
              <div className="flex-1">
                <label htmlFor="total" className="block text-white text-sm mb-1">Total*</label>
                <input
                  type="number"
                  id="total"
                  name="total"
            ...
            <div className="flex items-center">
              ...
              />
              <label htmlFor="reimbursable" className="text-sm text-white">Reimbursable</label>
            </div>
            ...
            <div>
              <label htmlFor="employee" className="block text-white text-sm mb-1">Employee*</label>
              <input
                type="text"
                id="employee"
                name="employee"
